...
/**
 * 继承TextView兼容包，9.0源码也是如此
 * 参考：AppCompatViewInflater.java   86行 + 138行 + 206行
 */
public class SkinnableTextView extends AppCompatTextView implements ViewsMatch {
    ...
    public SkinnableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableTextView,
                defStyleAttr, 0);
        //存储到临时JavaBean对象
